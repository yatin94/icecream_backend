...
old_flavors = cur_old.execute("SELECT IceCreamSize.* FROM IceCreamType join IceCreamSize on IceCreamSize.ice_cream_type_id == IceCreamType.id where IceCreamType.type = 'Sundae';").fetchall()
print(old_flavors)
exit()
